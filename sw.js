const CACHE='chris-list-2';
self.addEventListener('install',e=>{e.waitUntil(caches.open(CACHE).then(c=>c.addAll(['./','./index.html','./app.js','./style.css','./offline.js','./fixes.js','./donors.js'])));self.skipWaiting();});
