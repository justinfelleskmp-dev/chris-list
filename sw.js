const CACHE='chris-list-4';
self.addEventListener('install',e=>{e.waitUntil(caches.open(CACHE).then(c=>c.addAll(['./','./index.html','./app.js','./style.css','./sections.css','./offline.js','./fixes.js','./donors.js','./scan-ui.js'])));self.skipWaiting();});
