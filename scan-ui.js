...
render=function(){
 ...
 const schedule=document.createElement('p');schedule.className='small';schedule.textContent='Automatic Mac scans: 9am, 1pm, 5pm Pacific. Mac must be on and online. Phone Scan now uses GitHub instead.';bar.append(schedule);
